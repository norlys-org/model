...
def download_iata():
    ...
    params = '&sample_rate=60&compress=undefined&stations=NAL_LYR_HOR_HOP_BJN_NOR_SOR_KEV_TRO_MAS_AND_KIL_IVA_ABK_MUO_KIR_RST_SOD_PEL_JCK_DON_RAN_RVK_LYC_OUJ_MEK_HAN_DOB_SOL_NUR_HAR_UPS_KAR_PPN_'

    for year in tqdm(range(2024, 2025), desc="Downloading data for each year"):
